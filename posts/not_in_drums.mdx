...
'おこづかい帳' は単語ベクトルに含まれていません。
'消化器系' は単語ベクトルに含まれていません。
'Anitube' は単語ベクトルに含まれていません。
'緊急脱出用出口' は単語ベクトルに含まれていません。
'レレレのおじさん' は単語ベクトルに含まれていません。
'大憲章' は単語ベクトルに含まれていません。
'千歯扱き' は単語ベクトルに含まれていません。
'陸軍の統帥権' は単語ベクトルに含まれていません。
'ドラム' の類似度（降順）:
液体窒素: 0.3507
チャイルドシート: 0.2766
感情: 0.2256
